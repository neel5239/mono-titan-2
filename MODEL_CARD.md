...
- Runs on this repo (RTX 4050 laptop GPU), same 733-image stratified hold-out for all:
  ...
  - **B2-512 Pro (clone :8001 now)**: 512 model fine-tuned 4 epochs with the phone-plus-lens capture simulation on 50% of images; best epoch chosen on the mean of normal and phone-simulated hold-out QWK. Normal hold-out as served: QWK 0.911, AUC 0.984, sensitivity 0.980 / specificity 0.920. Phone-simulated hold-out: QWK 0.853, sensitivity 0.896 / specificity 0.908 (starting model: QWK 0.689, sensitivity 0.685). On a synthetic hand-held-lens photo of a Moderate NPDR retina the plain 512 model said No DR; Pro says Mild and routes to recheck.
